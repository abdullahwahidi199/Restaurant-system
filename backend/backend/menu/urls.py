...
from .views import category_list_create, CategoryRetrieveDestroyView,MenuItemRetrieveDestroyView,menu_item_list_create_view
...
urlpatterns = [
    ...
    path('menu-items/<int:pk>/', MenuItemRetrieveDestroyView.as_view(), name='menuitem-detail-destroy'),
