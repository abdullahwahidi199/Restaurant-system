    ...
    return (
        <div className="p-4 space-y-4" dir={isRTL ? "rtl" : "ltr"}>
            <div className="flex items-center justify-between mb-2">
                <h2 className="text-lg font-semibold text-gray-800">{t("all_customers")}</h2>
                <span className="text-sm text-gray-500">
                    {t("total_customers")}:{" "} <span className="font-medium text-gray-800">{filteredCustomers.length}</span>
                </span>
            </div>
