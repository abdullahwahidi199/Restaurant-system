      ...
      >
        <thead className="bg-gradient-to-r from-gray-200 to-gray-400  ">
          <tr>
            ...
            <th
              className={`px-6 py-4 text-right font-semibold text-gray-700  uppercase tracking-wider ${isRTL ? "text-left" : "text-right"}`}
            >
            ...
            staff.map((s) => (
              ...
              >
                <td className="px-6 py-4 font-medium text-gray-800 ">
                  <span
                    className={`${s.status == "Inactive" ? "line-through text-gray-500" : ""}`}
                  >
                    {s.name}
                  </span>
                </td>
