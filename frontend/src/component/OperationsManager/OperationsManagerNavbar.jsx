...
import {
  ...
  getOperationsManagerNavigationGroups,
  getExpandedIdsForOperationsManagerPath,
  isOperationsManagerNavigationItemActive,
...
function OperationsManagerNavbar({
  collapsed,
  mobileOpen,
  onToggleCollapse,
  onCloseMobile,
  ...
  const groups = useMemo(
    () => getOperationsManagerNavigationGroups(t, role),
    [t, role],
  );

  const activeItem = useMemo(
    () => findActiveOperationsManagerNavigationItem(groups, location.pathname),
  ...
  const [expandedIds, setExpandedIds] = useState(() => {
    ...
    getExpandedIdsForOperationsManagerPath(groups, location.pathname).forEach(
      (id) => saved.add(id),
    );
    return saved;
  });
      ...
      {items
        ...
        .map((item) => {
          ...
          const active = item.children?.length
            ? isOperationsManagerNavigationItemActive(location.pathname, item)
...
export default OperationsManagerNavbar;
