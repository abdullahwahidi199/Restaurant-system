...
import { findActiveOperationsManagerNavigationItem } from "./OperationsManagerNavigation";
import OperationsGlobalSearch from "./OperationsManagerSearch";
...
export default function OperationsManagerTopHeader({
  navigationGroups,
  onOpenSidebar,
}) {
  ...
  return (
    <header className="admin-topbar" ref={headerRef}>
      ...
      <div className="admin-topbar-search">
        <OperationsGlobalSearch navigationGroups={navigationGroups} />
      </div>
