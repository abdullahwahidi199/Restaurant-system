...
import { getFinanceManagerNavigationGroups } from "./financeManangerNavigation";
import FinanceTopHeader from "./FinanceManagerTopHeader";
import FinanceNavbar from "./FinanceManagerNavbar";
...
export default function FinanceManagerLayout() {
  ...
  const navigationGroups = useMemo(
    () => getFinanceManagerNavigationGroups(t, auth?.user?.role),
    [t, auth?.user?.role],
  );
